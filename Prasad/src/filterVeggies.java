...
public class filterVeggies {
	...
	public static void main(String[] args) {
		...
		List<WebElement> veggieStream =veggieList.stream().filter(s-> s.getText().contains("Rice")).collect(Collectors.toList());
		
		Assert.assertEquals(veggieList.size(), veggieStream.size());
	}
}
